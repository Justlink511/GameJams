class level2 {
    ...
    load(pImageLoader) {
        ...
        this.imgBackground = this.imageLoader.getImage("images/levl2BG.png");
        ...
        let imgEnnemyMothership = this.imageLoader.getImage("images/Ennemy2Mothership.png");
        let spriteEnnemyMothership = new Sprite(imgEnnemyMothership);
        spriteEnnemyMothership.setTileSheet(256, 256);
        ...
        this.wavesManager.AddWave(new EnnemyWave(spriteEnnemyMothership, "MotherShip2", 1, 100, 2000, false, -400, 250, this.lstBullets, this.hero));
        this.wavesManager.AddWave(new EnnemyWave(spriteEnnemyLaser, "Laser", 1, 8, 2500, true, 10, -60, this.lstBullets, this.hero));
        this.wavesManager.AddWave(new EnnemyWave(spriteEnnemyShip, "Ship", 8, 2, 1800, true, 500, -60, this.lstBullets, this.hero));
    }
    update(dt) {
        ...
        if (this.background.distance >= 2700 && this.background.distance <= 2705 && this.lstPowerUp.length < 1) {
            let pu = new PowerUp(300, -20, "Attack");
            this.lstPowerUp.push(pu);
        }
        if (this.background.distance >= 2000 && this.background.distance <= 2005 && this.lstPowerUp.length < 1) {
